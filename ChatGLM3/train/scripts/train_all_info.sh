...
#SBATCH -p gpu
#SBATCH -J train_all_info
#SBATCH -N 1
#SBATCH -n 48
#SBATCH -o train_all_info.o
#SBATCH -e train_all_info.e
#SBATCH --gres=gpu:8
...
OUTPUT_DIR=../output/chatglm_all_info_qlora
MASTER_PORT=$(shuf -n 1 -i 10000-65535)

mkdir -p $OUTPUT_DIR

# deepspeed --include localhost:0 finetune.py\
torchrun --standalone --nnodes=1 --nproc_per_node=$NUM_GPUS ../finetune_all_info.py \
