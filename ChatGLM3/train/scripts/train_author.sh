...
#SBATCH -p gpu
#SBATCH -J train_author
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -o train_author.o
#SBATCH -e train_author.e
#SBATCH --gres=gpu:8
...
MAX_SOURCE_LEN=15000 # longer context contains more paper titles, but cost longer train time and larger memory usage
MAX_TARGET_LEN=16
DEV_BATCH_SIZE=1
...
OUTPUT_DIR=../output/chatglm_author
...
torchrun --standalone --nnodes=1 --nproc_per_node=$NUM_GPUS ../finetune_authors.py \
